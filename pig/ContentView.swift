        ...
        NavigationView{
            ...
            ZStack{
                ...
                VStack{
                    ...
                    NavigationLink("How to play", destination: InstructionsView()).font(Font.custom("Marker Felt",size: 24))
                        .padding()
                    Spacer()
                }
            }
            ...
            ZStack{
                ...
                CustomText(text: "Pig")
                    ...
                    Text("If the player chooses to \"hold\", their turn total is added to the game score, and it becomes the next player's turn.")
                        .padding()
                    Text("A player wins the game when the game score becomes 100 points or more on their turn.")
                        .padding()
                }
                Spacer()
            }
